<template>
  <v-app-bar
    ...
    <v-toolbar-title>AASTU Extension Students Portal</v-toolbar-title>
    <v-spacer></v-spacer>
    ...
    <v-menu
      ...
      nudge-bottom="10">
        ...
        <v-list>
          <div class="text-h5 grey--text text--darken-3 px-4 pt-4">{{userdetail.fname+' '+ userdetail.lname}}</div>
       <div class="text-h5 grey--text text--darken-3 px-4 pt-4">{{userdetail.email}}</div>
